...
/* For S5PC110/V210 AC97 Clock/Power Gating by s3c-ac97.c */
	...
	pm_message_t state)
{
	...
	s3c_ac97_resume_from_codec();		/* in order to access codec */
	...
	s3c_ac97_suspend_from_codec();		/* now, safe to enter suspend */
...
static int wm9713_soc_resume(struct platform_device *pdev)
{
	...
	wm9713_reset(codec, 0);			/* No warm reset at first */
	ret = wm9713_reset(codec, 1);		/* Try warm reset */
	if (ret < 0) {
