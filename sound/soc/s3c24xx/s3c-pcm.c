...
static __devinit int s3c_pcm_dev_probe(struct platform_device *pdev)
{
	...
	s3c_pcm_dai[pdev->id].symmetric_rates = 0;	/* non-symmetric rate mode */
	s3c_pcm_dai[pdev->id].ops = &s3c_pcm_dai_ops;;
	s3c_pcm_dai[pdev->id].playback.channels_min = 1;	/* PCM dai : match Playback channels_min value with wm8580_dai(@wm8580.c) */
	...
	s3c_pcm_dai[pdev->id].capture.channels_min = 1;		/* PCM dai : fix channel_min value to enable Mono recording */
