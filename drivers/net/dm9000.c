...
dm9000_probe(struct platform_device *pdev)
{
	...
	if (is_valid_ether_addr(my_ethaddr)){
		mac_src = "my ether";
		ndev->dev_addr[0] = my_ethaddr[0];
		ndev->dev_addr[1] = my_ethaddr[1];
		ndev->dev_addr[2] = my_ethaddr[2];
		ndev->dev_addr[3] = my_ethaddr[3];
		ndev->dev_addr[4] = my_ethaddr[4];
		ndev->dev_addr[5] = my_ethaddr[5];
	}
