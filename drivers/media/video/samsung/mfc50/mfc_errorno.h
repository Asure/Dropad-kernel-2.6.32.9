...
typedef enum
{
	...
	MFCINST_ERR_OPEN_TIMEOUT_FAIL = -1109,
	MFCINST_ERR_CLOSE_TIEMOUT_FAIL = -1110,
	...
	MFCINST_ERR_FW_LOAD_TIMEOUT_FAIL = -5101,
	
	MFCINST_ERR_GET_INST_FAIL = -6001,	
	MFCINST_ERR_INST_NUM_EXCEEDED = -6002,
	MFCINST_ERR_SET_CONF = -6003,
	MFCINST_ERR_GET_CONF = -6004,
	
	MFCINST_MEMORY_INVALID_ADDR = -7001,
	MFCINST_MEMORY_MAPPING_FAIL = -7002,
	...
	MFCINST_SLEEP_TIMEOUT_FAIL = -8007,
	MFCINST_WAKEUP_TIMEOUT_FAIL = -8108,
